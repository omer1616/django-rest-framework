...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Django\djangoRestFramework\restFramework\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Django\djangoRestFramework\restFramework\venv\Scripts\deactivate.nu'
